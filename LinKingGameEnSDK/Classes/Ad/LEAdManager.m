...
- (void)initializationBannerRootViewController:(UIViewController *)viewController superView:(UIView *)superView{
    ...
    // LEPLATFORM_Facebook
    [self initializationBannerRootViewController:viewController superView:superView platform:LEPLATFORM_IronSource];
...
- (void)initializationInterstitialAd:(UIViewController *)viewController{
    ...
    [self initializationInterstitialAd:viewController platform:LEPLATFORM_IronSource];
}
...
- (void)initializationRewardVideoAd:(UIViewController *)viewController{
    [self initializationRewardVideoAd:viewController platform:LEPLATFORM_IronSource];
